...
const SignInModal = () => {
  ...
  return (
    <div
      id="signinBox"
      className="fixed w-full h-full bg-black/30 top-0 left-0 z-50 flex justify-center items-center"
    >
      <div className="bg-white rounded-xl border-[1px] border-neutral-400 w-10/12 sm:w-6/12 md:w-5/12 lg:w-4/12 xl:w-3/12 2xl:w-1/5 shadow-2xl flex flex-col justify-between">
        <div className="border-b-[1px] border-neutral-300 p-2 text-xl font-bold">
          Sign in
        </div>
        <form
          id="signinForm"
        ...
        >
          <div className="flex flex-col">
            ...
            <input
              ...
              name="username"
              type="text"
              className="p-2 border-[1px] outline-0"
              defaultValue={`kate_h`}
              autoComplete="off"
            />
          </div>
          <div className="flex flex-col">
            ...
            <div className="relative flex items-center w-full">
              <input
                ...
                name="password"
                type="password"
                className="p-2 border-[1px] outline-0 w-full"
          ...
          <div className="flex mt-3 gap-2 items-center justify-between">
            <div className="flex gap-2">
              <button
                type="submit"
                onClick={signInLoad}
                className="bg-teal-600 bg-opacity-80 hover:bg-opacity-100 p-2 text-white rounded select-none flex items-center gap-1"
              >
              ...
              <button
                type="button"
                className="p-2 text-teal-600 opacity-80 hover:opacity-100 rounded select-none"
              >
                Sign up
              </button>
            </div>
