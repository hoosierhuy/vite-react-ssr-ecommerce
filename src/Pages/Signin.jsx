    ...
    return (
      <div className="flex flex-col lg:flex-row gap-6 border lg:gap-2 my-8 w-full lg:w-3/4 self-center rounded-xl shadow-md shadow-slate-100">
        <form
          ...
          className="flex-1 p-4 flex flex-col gap-4 place-items-center justify-start"
          autoComplete="off"
        >
          ...
          <div className="flex flex-col w-full md:w-2/3 xl:w-1/2">
            ...
            <input
              ...
              id="username"
              defaultValue={'kate_h'}
              className="border border-neutral-600 rounded-sm text-xl p-2 outline-slate-500"
            />
          </div>
          <div className="flex flex-col w-full md:w-2/3 xl:w-1/2">
            ...
            <div className="relative flex items-center w-full">
              <input
                autoComplete="off"
                id="password"
                defaultValue={'kfejk@*_'}
                type="password"
                className="border border-neutral-600 rounded-sm text-xl p-2 outline-slate-500 w-full"
              />
              <button
                onClick={showPassword}
                className="absolute right-0 mr-2 text-slate-600"
                type="button"
              >
                <svg
                  id="show"
                ...
                <svg
                  ...
                  height="20"
                  fill="currentColor"
                  className="bi bi-eye-slash hidden"
                  viewBox="0 0 16 16"
                >
          ...
          {signErr && (
            <div className="leading-none border-[1px] border-red-100 text-sm bg-red-50 w-full md:w-2/3 xl:w-1/2 p-2 rounded font-medium">
              Incorrect username or password
            </div>
          )}
          <div
            className={`flex justify-between items-center w-full md:w-2/3 xl:w-1/2 ${
              !signErr ? 'mt-4' : ''
            }`}
          >
            ...
            <div className="flex gap-2 items-center">
              <button
                type="button"
                className="bg-neutral-100 text-sm text-neutral-600 rounded-sm p-2"
              >
                Sign up
              </button>
              <button
                type="submit"
                onClick={signInLoad}
                className="bg-orange-600 text-white rounded-sm p-2 flex items-center gap-1 hover:bg-opacity-90"
              >
                ...
                <svg
                  ...
                  height="14"
                  fill="currentColor"
                  className="bi bi-arrow-clockwise leading-none hidden"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
        ...
        <div className="w-full lg:w-1/3 bg-gradient-to-b lg:bg-gradient-to-r pt-8 px-8 from-transparent from-0% via-20% to-60% via-slate-50 to-slate-100 rounded-lg min-h-96 flex justify-center items-center ">
          <div className="grid place-items-center gap-3">
            <img
              width={160}
              height={160}
              className="rotate-12 skew-x-6 w-40 h-40 mix-blend-multiply duration-1000"
              src={data[13]?.image}
            />
            <img
              width={128}
              height={128}
              className="rotate-6 -skew-y-12 w-32 h-32 mix-blend-multiply duration-1000"
              src={data[5]?.image}
            />
          </div>
          <img
            width={112}
            height={112}
            className="-rotate-12 -skew-x-6 w-28 h-28 mix-blend-multiply duration-1000"
            src={data[2]?.image}
          />
        </div>
      </div>
