              ...
              <form className="lg:col-span-2">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-8">
                    <Link
                      to={`/`}
                      className="px-7 py-3.5 text-sm tracking-wide bg-white text-gray-800 rounded-md cursor-pointer"
                    >
                      Pay later
                    </Link>
                    <button
                ...
                <div className=" w-full">
                  ...
                  <ul className="text-gray-800 mt-6 space-y-3">
                    <li className="flex flex-wrap gap-4 text-sm">
                      Sub total{' '}
                      <span className="ml-auto font-bold">${summary}</span>
                    </li>
                    <li className="flex flex-wrap gap-4 text-sm">
                      Discount (20%){' '}
                    ...
                    <li className="flex flex-wrap gap-4 text-base font-bold">
                      Total <span className="ml-auto">${summary}</span>
                    </li>
                  </ul>
                </div>
                <Link
                  className="p-2 bg-amber-600 hover:bg-opacity-90 text-white rounded-md"
                  to={`/cart`}
                >
                  Cart details
                </Link>
